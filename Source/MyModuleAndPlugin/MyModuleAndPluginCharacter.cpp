...
#include "TestLogModule/TestActor/TestActor.h"
#include "TestLogPlugin/PluginTestActor.h"
...
void AMyModuleAndPluginCharacter::NotifyControllerChanged()
{
...
void AMyModuleAndPluginCharacter::BeginPlay()
{
	...
	{
		World->SpawnActor<ATestActor>(ATestActor::StaticClass());
		
		World->SpawnActor<APluginTestActor>(APluginTestActor::StaticClass());
	}
}
